...
var icon=node.find("span.icofont");
...
if(_15e(_15c,node[0])){
var _15f=node.find("span.icofont");
_15f.removeClass("icofont-caret-right ").addClass("tree-folder tree-folder-open");
...
node.find(".icofont").removeClass("tree-folder").addClass("icofont-caret-right ");
...
if(data.iconCls){
node.find(".icofont").removeClass(data.iconCls);
}
$.extend(data,_16c);
node.find(".tree-title").html(opts.formatter.call(_16b,data));
if(data.iconCls){
node.find(".icofont").addClass(data.iconCls);
}
...
cc.push("<span class=\"icofont tree-folder "+(item.iconCls?item.iconCls:"")+"\"></span>");
}else{
if(item.children&&item.children.length){
cc.push("<span class=\"tree-hit tree-expanded\"></span>");
cc.push("<span class=\"icofont "+(item.iconCls?item.iconCls:"")+"\"></span>");
}else{
cc.push("<span class=\"tree-indent\"></span>");
cc.push("<span class=\"icofont icofont-caret-right  "+(item.iconCls?item.iconCls:"")+"\"></span>");
}
}
...
var _a64=cell.children("span.icofont");
if(_a64.hasClass("icofont-caret-right ")){
_a64.removeClass("icofont-caret-right ").addClass("tree-folder tree-folder-open");
...
var cell=_a76(node);
cell.find(".icofont").prev().addClass("tree-join");
}
});
if(_a79.length){
...
if(row.state=="closed"){
cc.push("<span class=\"tree-hit tree-collapsed\"></span>");
cc.push("<span class=\"icofont tree-folder "+(row.iconCls?row.iconCls:"")+"\"></span>");
}else{
if(row.children&&row.children.length){
cc.push("<span class=\"tree-hit tree-expanded\"></span>");
cc.push("<span class=\"icofont "+(row.iconCls?row.iconCls:"")+"\"></span>");
}else{
cc.push("<span class=\"tree-indent\"></span>");
cc.push("<span class=\"icofont icofont-caret-right  "+(row.iconCls?row.iconCls:"")+"\"></span>");
}
}
...
tr.next("tr.treegrid-tr-tree").remove();
var cell=tr.children("td[field=\""+opts.treeField+"\"]").children("div.datagrid-cell");
cell.find(".icofont").removeClass("tree-folder").addClass("icofont-caret-right ");
