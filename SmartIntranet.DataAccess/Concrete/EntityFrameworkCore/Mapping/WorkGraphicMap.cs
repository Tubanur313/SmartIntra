...
{
    public class WorkGraphicMap : IEntityTypeConfiguration<WorkGraphic>
    {
        public void Configure(EntityTypeBuilder<WorkGraphic> builder)
        {
            ...
            builder.HasOne(s => s.NonWorkingYear)
                   .WithMany(s => s.WorkGraphics)
                   .HasForeignKey(s => s.NonWorkingYearId).OnDelete(DeleteBehavior.Restrict);
