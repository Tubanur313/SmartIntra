...
namespace SmartIntranet.DataAccess.Concrete.EntityFrameworkCore.Context
{
    public class IntranetContext : IdentityDbContext<IntranetUser, IntranetRole, int, IntranetUserClaim, IntranetUserRole, IntranetUserLogin, IntranetRoleClaim, IntranetUserToken>
    {
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            //optionsBuilder.UseSqlServer(@"Server=(localdb)\mssqllocaldb;Database=RealIntranetSmart;Trusted_Connection=False;MultipleActiveResultSets=true");

            optionsBuilder.UseSqlServer(@"Server=178.63.85.231;Initial Catalog=DemoIntranetTest10;User Id=mahir;Password=p8Mfs4&6;MultipleActiveResultSets=true");
