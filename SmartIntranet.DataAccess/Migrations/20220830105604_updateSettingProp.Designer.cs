...
namespace SmartIntranet.DataAccess.Migrations
{
    ...
    [Migration("20220830105604_updateSettingProp")]
    partial class updateSettingProp
    {
            ...
            modelBuilder.Entity("SmartIntranet.Entities.Concrete.Intranet.Vacancy", b =>
                {
                    ...
                    b.Property<DateTime>("StartDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 8, 30, 14, 56, 3, 423, DateTimeKind.Local).AddTicks(393));
